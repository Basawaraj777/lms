...
export async function deleteLessons({
  ...
  try {
    ...
    return {
      status: "success",
      message: "Lesson deleted and poisitions reordered successfully",
    };
  } catch {
    return {
      status: "error",
      message: "Falied to delete lesson",
    };
  }
}
...
export async function deleteChapter({
  ...
  try {
    ...
    const updates = remainingChapters.map((lesson, index) => {
    ...
    return {
      status: "success",
      message: "Chapter deleted and poisitions reordered successfully",
    };
  } catch (error) {
    console.log(error);
    ...
    return {
      status: "error",
      message: "Falied to delete chapter",
    };
  }
}
